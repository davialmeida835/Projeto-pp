...
//	}
	...
	private void adicionarTabela() {
		ClienteTabela tabelaFeita = new ClienteTabela();
		
		String[] dados = {"Nome", "Telefone", "E-mail", "Identificador"};
	...
	private void filtrarClientes() {
		...
		RowFilter<DefaultTableModel, Object> rowFilter = RowFilter.regexFilter("(?i)" + nomeFiltro, 0); // O índice 0
																										// refere-se à
																										// coluna do
																										// nome
